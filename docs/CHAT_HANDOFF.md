...
Aktuelle Zielversion: `2026.08.08-camera-gforce-android.4`. Der vorherige stabile Produktionsstand ist am Commit `5a4f178947b144694543161e1f8a459ab19a07b5` und Branch `rollback/pre-park-map-weather-20260808` dokumentiert. Web startet Vollbild jetzt unmittelbar bei der Aufnahmevorbereitung und führt eine fehlende Kalibrierung automatisch aus. Der horizontale und vertikale G-Kraft-Verlauf zeigt exakt die letzten drei Sekunden als weich auslaufenden, zunehmend transparenten Schweif. Android bindet CameraX-Preview und Video gemeinsam, verwendet auf Huawei den kompatiblen Preview-Modus und besitzt ein immersives natives Kamera-HUD, dunkles RideTracker-Design, Logo/Icons sowie horizontale Navigations- und vertikale Vollbildgesten. Eindeutige Device-v4- und Fire-v4-Paket-IDs verhindern Konflikte mit älteren Debug-Signaturen. Die bisherigen Funktionen wie Parkkarte, Wetter, lizenzierte Thumbnails, ICE-GPS-Zeitbasis, Kalibrierungs-Lageprüfung und Supabase-Datenschutzfunktionen bleiben erhalten.
