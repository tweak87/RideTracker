...
Der Android-Workflow testet und prüft die App, verifiziert die Geräte- und Fire-APK zusätzlich mit `apksigner`, `aapt` und vollständigen Archivtests und veröffentlicht Builds von `main` als Vorab-Release unter [`android-v2026.08.09.4`](https://github.com/tweak87/RideTracker/releases/tag/android-v2026.08.09.4). Auf Huawei/Android `INSTALL-RideTracker-ANDROID-DEVICE-v2026.08.09.4.apk`, auf Fire OS 8 ausschließlich `INSTALL-RideTracker-FIRE-OS-8-v2026.08.09.4.apk` öffnen. Die Version ergänzt korrigierte GPS-/Gehmessung, GNSS-Qualität, gemeinsames HUD, bessere Scroll-/Tastaturbedienung, Park-/Attraktionswahl, Fahrt-Vollständigkeit und ein geglättetes 3D-Achterbahnmodell. Beide Testpakete verwenden neue v8-Paket-IDs und können deshalb ohne Signaturkonflikt neben älteren Builds installiert werden. Die Test-APKs sind nicht für einen App-Store signiert; für wiederholte Updates und eine öffentliche Verteilung wird ein geschützter Release-Key benötigt. Fire-Hinweise stehen in [`docs/ANDROID_FIRE_INSTALL.md`](docs/ANDROID_FIRE_INSTALL.md). Der iOS-Workflow prüft den Swift-Code mit einem Simulator-Build; für die Installation auf einem realen iPhone ist ebenfalls Signierung erforderlich.
