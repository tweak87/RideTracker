(() => {
  ...
  function patchSafeBoot() {
    ...
    const safeBoot=()=>{closeFoundationViews();byId('rtRideDraft61')?.setAttribute('hidden','');const result=original();renderHome();syncBottomNav();return result;};safeBoot.__rt61=true;diagnostics.safeBoot=safeBoot;
  }
  function install() {
